...
import com.singularitycoder.viewmodelstuff2.utils.trimIndentsAndNewLines
...
internal val MIGRATION_1_TO_2 = object : Migration(1, 2) {
    override fun migrate(database: SupportSQLiteDatabase) {
        ...
        database.execSQL("ALTER TABLE table_anime_data ADD COLUMN myFavReasonDate TEXT DEFAULT NULL")
        database.execSQL("ALTER TABLE table_anime_data ADD COLUMN isFav INTEGER DEFAULT 0 NOT NULL")
    }
}
...
internal val MIGRATION_2_TO_3 = object : Migration(2, 3) {
    override fun migrate(database: SupportSQLiteDatabase) {
        ...
        database.execSQL("ALTER TABLE table_anime_data RENAME COLUMN isFav TO isFavourite")
    }
    ...
    private fun migrateIsFavColumnNameOfTableAnimeDataInTheOldWay(database: SupportSQLiteDatabase) {
        ...
        database.execSQL(
            """
                ...
                FROM $TABLE_ANIME_DATA
            """.trimIndentsAndNewLines()
        )

        // 3. Remove the old table.
        database.execSQL("DROP TABLE table_anime_data")
        ...
        database.execSQL("ALTER TABLE table_anime_data_temporary RENAME TO table_anime_data")
    }
}
